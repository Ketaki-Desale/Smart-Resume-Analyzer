...
connection = pymysql.connect(host='localhost', user='root', password='Ketaki@1234')
...
def run():
    ...
    img = Image.open(r"C:\Users\91779\Downloads\Smart_Resume_Analyser_App-master\Smart_Resume_Analyser_App-master\Logo\SRA_Logo.jpg")
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            #     time.sleep(4)
            save_image_path = r'C:\Users\91779\Downloads\Smart_Resume_Analyser_App-master\Smart_Resume_Analyser_App-master\Uploaded_Resumes' + pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'project' and ad_password == 'project123':
